...
Y0 = 80   # Coordonata inițială pe axa Y
...
while True:
    ...
    x2d = L1 * math.cos(math.radians(q2)) + L2 * math.cos(math.radians(q2 + q3)) + L3 * math.cos(math.radians(q2 + q3 + q4)) + X0
    y2d = L1 * math.sin(math.radians(q2)) + L2 * math.sin(math.radians(q2 + q3)) + L3 * math.sin(math.radians(q2 + q3 + q4)) + Y0
